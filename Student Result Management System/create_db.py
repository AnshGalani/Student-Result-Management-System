...
def create_db():
    ...
    cur.execute("CREATE TABLE IF NOT EXISTS result(rid INTEGER PRIMARY KEY AUTOINCREMENT ,roll text,name text,course text,mark_ob text,full_mark text,per text)")
    con.commit()
