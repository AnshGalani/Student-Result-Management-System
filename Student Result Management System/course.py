...
class CourseClass:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Manage Course Details",font=("goudy old style",22,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1330,height=35)
        ...
        lbl_search_courseName=Label(self.root,text="Course Name",font=("goudy old style",15,'bold'),bg="white").place(x=780,y=60)
       
        txt_search_courseName=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=930,y=60,width=200)
