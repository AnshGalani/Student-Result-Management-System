...
class Register:
    def __init__(self,root):
        ...
        self.bg_img=self.bg_img.resize((1290,800),Image.ANTIALIAS)
        self.bg_img=ImageTk.PhotoImage(self.bg_img)
        
        self.lbl_bg=Label(self.root,image=self.bg_img).place(x=250,y=0,width=1290,height=800)
        #====Left Images===================
        ...
        #==============Terms=====================
        self.var_chk=IntVar()
        chk=Checkbutton(frame1,text="I Agree The Terms & Condition",font=("tims new roman",12,"bold"),bg="white",variable=self.var_chk,onvalue=1,offvalue=0).place(x=50,y=380)
        ...
        btn_login=Button(self.root,text="Sign In",command=self.login_window,font=("times new roman",20),bd=0,cursor="hand2").place(x=200,y=520,width=180)
...
#=============================================================================================================================
    ...
    def register_data(self):
        if self.txt_fname.get()=="" or self.txt_email.get()=="" or self.txt_contact.get()=="" or self.cmb_question.get()=="Select" or self.txt_answer.get()=="" or self.txt_password.get()=="" or self.txt_cpassword.get()=="":
            ...
            messagebox.showerror("Error","Password & Confiram Password Should Be Same",parent=self.root)
