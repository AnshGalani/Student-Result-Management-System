...
class StudentClass:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Manage Student Details",font=("goudy old style",22,"bold"),bg="#033054",fg="white").place(x=10,y=15,width=1330,height=35)
        ...
        lbl_addres=Label(self.root,text="Address",font=("goudy old style",15,'bold'),bg="white").place(x=10,y=260)
        ...
        lbl_addmission=Label(self.root,text="Addmission Date",font=("goudy old style",15,'bold'),bg="white").place(x=370,y=140)
        ...
        lbl_pin=Label(self.root,text="Pincode",font=("goudy old style",15,'bold'),bg="white").place(x=500,y=220)
        ...
        self.fetch_course()
        txt_dob=Entry(self.root,textvariable=self.var_dob,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=520,y=60,width=200)
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=520,y=100,width=200)
        txt_addmission=Entry(self.root,textvariable=self.var_a_date,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=520,y=140,width=200)
        ...
        txt_pin=Entry(self.root,textvariable=self.var_pin,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=590,y=220,width=130)
        
        #================Text Addres===================
        
        self.txt_address=Text(self.root,font=("goudy old style",15,'bold'),bg="lightyellow")
        self.txt_address.place(x=150,y=260,width=570,height=100)
        ...
        lbl_search_roll=Label(self.root,text="Roll No.",font=("goudy old style",15,'bold'),bg="white").place(x=780,y=60)
        txt_search_roll=Entry(self.root,textvariable=self.var_search,font=("goudy old style",15,'bold'),bg="lightyellow").place(x=930,y=60,width=200)
        
        btn_search=Button(self.root,text="Search",font=("goudy old style",15,"bold"),bg="#03a9f4",fg="white",cursor="hand2",command=self.search).place(x=1150,y=60,width=150,height=28)
        
        #=====================Content=================
        
        self.C_Frame=Frame(self.root,bd=2,relief=RIDGE)
        self.C_Frame.place(x=750,y=100,width=590,height=400)
